...
export const categories: Category[] = [
  {
    ...
    products: [
      ...
      { name: "Gorilla Glue", price: "8 €/g", prices: [{ label: "1g", price: "8 €" }, { label: "5g", price: "22 €" }, { label: "10g", price: "35 €" }], image: productGorillaGlue, description: "La Gorilla Glue est une variété légendaire, célèbre pour sa puissance et sa résine collante caractéristique.\n\n🍫 Saveur — Notes chocolatées et diesel avec une finition terreuse et piquante\n🔥 Résine — Production de trichomes exceptionnelle, texture collante signature\n🧘 Effet — Détente musculaire intense et relaxation profonde\n🌱 Culture — Cultivée en indoor avec un séchage lent pour maximiser les arômes\n📦 Conditionnement — Sachets hermétiques pour une conservation optimale\n\nPrimée à de nombreuses reprises, la Gorilla Glue impressionne par sa complexité aromatique et son taux de CBD généreux. Un must pour les amateurs de variétés puissantes et résineuses." },
